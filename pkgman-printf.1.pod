...
B<pkgman> printf [B<--sort>=I<FORMAT>] [B<--regex>] [B<--filter>=I<PKGNAME>] I<FORMAT>

=head1 DESCRIPTION

Print formatted list of available packages. It looks in all packages sources
...
Filter listing packages by name. The filter option argument may be the string,
wildcard or regex.
