...
string, wildcard in L<fnmatch(3)> format, or regex in L<regex(3)>
format.
...
%M | maintainer
%R | has readme               | yes/no
%A | has pre-install script   | yes/no
%B | has post-install script  | yes/no
%C | has pre-remove script    | yes/no
%D | has post-remove script   | yes/no
%l | is locked                | yes/no
...
=begin html
  ...
  <table>
    ...
    <tr>
      <td>&percnt;A</td>
      <td>has pre-install script</td>
      <td>yes/no</td>
    </tr>
    <tr>
      <td>&percnt;B</td>
      <td>has post-install script</td>
      <td>yes/no</td>
    </tr>
    <tr>
      <td>&percnt;C</td>
      <td>has pre-remove script</td>
      <td>yes/no</td>
    </tr>
    <tr>
      <td>&percnt;D</td>
      <td>has post-remove script</td>
      <td>yes/no</td>
    </tr>
    <tr>
      <td>&percnt;l</td>
...
"diff" for "%i" (is installed) variable means the package is installed
and different package version is available in the packages sources
directories.
